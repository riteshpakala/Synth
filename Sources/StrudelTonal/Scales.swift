// Scales.swift — GENERATED scale dictionary (from @tonaljs/scale-type data,
// MIT licensed, via Tools/). Do not edit by hand.

import Foundation

/// Scale type dictionary: name/alias → interval names.
enum ScaleData {
    static let intervals: [String: [String]] = [
